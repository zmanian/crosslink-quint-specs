...
packet, Malachite proposal protobuf, Malachite proposal gossip transport, Malachite liveness protobuf, Malachite sync protobuf, and Malachite sync gossip transport formats.
...
liveness protobuf, Malachite sync protobuf, Malachite sync gossip transport,
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  gating and the status packet format are modeled. Initial Malachite proposal, liveness, and sync protobuf vectors are pinned,
  and first proposal/sync gossip-envelope bridges exist; Malachite liveness
  gossip and broader production gossip integration remain open;
