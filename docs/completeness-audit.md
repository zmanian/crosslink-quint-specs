...
envelope, validator-scale progress contract, PoW stochastic assumptions,
...
nil-resampling/finality slice, plus the validator-scale stress envelope where
baseline Crosslink halts but nil-precommit resampling reaches a stable decision
after bounded burned rounds. They are not yet temporal proofs over the full
