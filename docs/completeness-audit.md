...
packet, and Malachite proposal protobuf formats.
...
Malachite proposal protobuf, and heighted authenticated gossip transport
models.
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  gating and the status packet format are modeled. Initial Malachite protobuf
  proposal vectors are pinned, but broader Malachite liveness/sync protobufs
  and full production gossip integration remain open;
