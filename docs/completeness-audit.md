...
packet, Malachite proposal protobuf, Malachite liveness protobuf, Malachite sync protobuf, and Malachite sync gossip transport formats.
...
protobuf, Malachite sync gossip transport, and heighted authenticated gossip
transport models.
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  and a first sync gossip-envelope bridge exists; Malachite proposal/liveness
