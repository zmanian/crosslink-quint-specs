...
packet, Malachite proposal protobuf, and Malachite liveness protobuf formats.
...
Malachite proposal protobuf, Malachite liveness protobuf, and heighted
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  gating and the status packet format are modeled. Initial Malachite proposal and liveness protobuf vectors are pinned, but
  Malachite sync protobufs and full production gossip integration remain open;
