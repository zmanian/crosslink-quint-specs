...
vote/proposal sign bytes, Tenderlink vote packets, and heighted authenticated
gossip transport models.
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  Tenderlink vote sign-byte, legacy proposal-chunk sign-byte, and vote packet
  layouts are now pinned, but complete cross-message packet vectors, Malachite
  protobuf proposal vectors, and production gossip integration remain open;
