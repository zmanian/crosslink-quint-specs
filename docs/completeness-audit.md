...
contract, composed progress contract, stream-churn risk, validator-scale liveness
...
finality-progress, composed-progress, delivery-fairness, timeout-progress, stream-churn,
...
nil-resampling/finality slice, plus validator-scale stress envelopes where
baseline Crosslink halts but nil-precommit resampling reaches a stable decision
and then finalizes after bounded burned rounds. They are not yet temporal
