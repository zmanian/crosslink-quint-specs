...
Tenderlink vote packet and consensus packet formats.
...
packets, and heighted authenticated gossip transport models.
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  compact consensus packet layouts are now pinned, but Malachite protobuf
  proposal vectors and production gossip integration remain open;
