...
accountability evidence, nonce/ack transport, status
...
packets, Tenderlink accountability evidence, Tenderlink nonce/ack transport,
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  compact consensus packet layouts are now pinned, with a focused
  proposal/POL transport bridge for the valid-round evidence path. Known-peer
