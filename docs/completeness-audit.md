...
packet, Malachite proposal protobuf, Malachite liveness protobuf, and Malachite sync protobuf formats.
...
Malachite proposal protobuf, Malachite liveness protobuf, Malachite sync
protobuf, and heighted authenticated gossip transport models.
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  liveness, and sync protobuf vectors are pinned, but full production gossip
