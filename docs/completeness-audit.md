...
authenticated gossip transport, Tenderlink vote sign bytes, and Tenderlink
proposal chunk sign bytes.
...
vote/proposal sign bytes, and heighted authenticated gossip transport models.
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  Tenderlink vote and legacy proposal-chunk sign-byte layouts are now pinned,
  but complete packet vectors, Malachite protobuf proposal vectors, and
