...
Tenderlink vote packet, consensus packet, and nonce/ack transport formats.
...
packets, Tenderlink nonce/ack transport, and heighted authenticated gossip
transport models.
...
- link message-authentication and evidence-gossip models to concrete production
  ...
  gating is modeled, but Malachite protobuf proposal vectors and full
  production gossip integration remain open;
