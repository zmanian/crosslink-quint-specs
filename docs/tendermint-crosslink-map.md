...
- Connect the heighted authentication and evidence-gossip models to production
  ...
  and the production Tenderlink ingress bridge now gates those router records
  behind node-local production ingress.
