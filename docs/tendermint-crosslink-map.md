...
- Connect the dynamic-sigma consensus-param format/transport models to real
  ...
  exists. The proposal-carried dynamic-sigma evidence payload now has
  implementation-linked serialization vectors, but still needs full proposal
  gossip/payload integration.
