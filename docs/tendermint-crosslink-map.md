...
- Connect the heighted authentication and evidence-gossip models to production
  ...
  value-precommit-certificate, while the production finality ingress/projection
  bridge gates the same evidence behind accepted Tenderlink ingress.
