...
- Connect the heighted authentication and evidence-gossip models to production
  ...
  the production finality ingress/projection bridge also gates finality
  precommit evidence behind accepted Tenderlink value-precommit-certificate
  ingress.
