...
- Connect the dynamic-sigma consensus-param format/transport models to real
  ...
  dynamic-sigma BFT payload, and prototype decode gate now have
  implementation-linked serialization, payload-shape, and config-gate vectors,
  but still need full production gossip integration.
