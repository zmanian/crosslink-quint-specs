...
- Connect the dynamic-sigma consensus-param format/transport models to real
  ...
  exists. The proposal-carried dynamic-sigma evidence payload and tagged
  dynamic-sigma BFT payload now have implementation-linked serialization and
  payload-shape vectors, but still need full production gossip integration.
