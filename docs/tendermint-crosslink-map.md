...
- Connect the dynamic-sigma consensus-param format/transport models to real
  ...
  dynamic-sigma BFT payload, prototype decode gate, production payload ingress
  bridge, and verifier-friendly ingress projection now have
